  ...
  return {
    ...
    pwa: {
      ...
      manifest: {
        name: 'Weather',
        short_name: 'Weather',
        description: 'A weather app built with Quasar',
        display: 'standalone',
    ...
    electron: {
      ...
      builder: {
        ...
        appId: 'com.day41.weather',
        productName: 'Quasar Weather',
        ...
        publish: [
          {
            ...
            // repo scope e5da21f73ae12df02904e8830b67af8cdd4bd3d7
          },
        ],
      },
